...
function App() {
  ...
  const handleClaimClick = async () => {
    ...
    // Check if code exists in Firebase global_codes
...
VIPပေးတာကို  admin tapထဲမှာပဲ Buttom တစ်ခုအနေနဲ့ထုတ်ပေးပါဗျ

Watchနေရာမှာ ကြော်ငြာပေးတဲ့ amountဖော်ပြပေးပါ 
VIP ဆို 0.0009  , Normal ဆို 0.0004
ပြောင်းပေးပါမယ် 

ကျန်အဟောင်းတွေမပျက်ပါ
