...
const APP_CONFIG = {
  ...
  ADS_ID_1: "27611",    // Old ID
  ADS_ID_2: "29164006", // New ID (from your image)
...
function App() {
  ...
  const processReward = (id, rewardAmount) => {
    ...
    if (window.Adsgram) {
      // Logic: အခုကြည့်တဲ့အကြိမ်က မစုံကိန်းဆိုရင် ID 1၊ စုံကိန်းဆိုရင် ID 2 (Ads ၂ ခုလုံး တက်အောင်လုပ်ထားတာပါ)
      const selectedBlockId = (adsWatched % 2 === 0) ? APP_CONFIG.ADS_ID_2 : APP_CONFIG.ADS_ID_1;
      ...
      }).catch((e) => alert("Ads loading... Please try again."));
    }
  };
  ...
  const styles = {
    ...
    taskBox: { maxHeight: '380px', overflowY: 'auto', paddingRight: '5px' }, // Scroll Bar Fix
  ...
  return (
    <div style={styles.main}>
      ...
      {/* Other sections like Withdraw, Invite, Profile remain the same as your previous stable version */}
