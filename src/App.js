...
function App() {
  ...
  const processReward = (id, rewardAmount) => {
    ...
    if (window.Adsgram) {
      // Use block 29164006 as the primary ad unit for "WATCH ADS" button
      const selectedBlockId = isWatchAd ? APP_CONFIG.ADS_SECOND_ID : APP_CONFIG.ADSGRAM_BLOCK_ID;
      ...
      AdController.show()
        ...
        .catch((err) => {
          ...
          alert("Ad failed to load. Please check your internet or try again later.");
        });
    } else {
      alert("Adsgram not loaded. Check script tag.");
    }
  };
  ...
  const fixedBotTasks = [
    ...
    { id: 'b3', name: "Workers On TON", link: "
