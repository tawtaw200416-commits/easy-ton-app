...
function App() {
  ...
  const styles = {
    ...
    tonLogo: { width: '50px', height: '50px', borderRadius: '50%', backgroundSize: 'cover', backgroundPosition: 'center', border: '2px solid #fbbf24', backgroundImage: 'url("https://t3.ftcdn.net/jpg/05/65/15/86/360_F_565158659_9I3kG0f6PzX2EwT6s0Uv5Q9b4bJvFp4w.jpg")' },
    ...
    <div style={styles.container}>
          ...
          {activeTab === 'social' && (
            <>
              ...
              <div style={{display: 'flex', gap: '10px'}}>
                <button style={{...styles.btn(), flex: 1, padding: '15px'}} onClick={() => alert('Add Task Form')}>+ Add Task</button>
                <button style={{...styles.btn('#38bdf8'), flex: 1, padding: '15px'}} onClick={() => alert('My Tasks')}>My Task</button>
              </div>
            </>
          )}
        </>
      ...
      {activeNav === 'invite' && (
        <div style={styles.card}>
          ...
          <input style={{...styles.input, color: '#94a3b8'}} value={`https://t.me/YourBot?start=${userUID}`} readOnly />
