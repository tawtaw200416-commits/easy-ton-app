    ...
    <div style={styles.main}>
      ...
      {activeNav === 'earn' && (
        <>
          ...
          {activeTab === 'social' && (
            <div>
              <button style={{ ...styles.yellowBtn, marginBottom: '15px' }} onClick={() => setShowForm(!showForm)}>+ ADD YOUR TASK</button>
              {showForm && (
                <div style={styles.card}>
                  <input style={styles.input} placeholder="Channel/Group Name" />
