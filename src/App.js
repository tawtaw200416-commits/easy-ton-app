        ...
        <>
          ...
          {activeTab === 'social' && showAddTask && (
            <div style={styles.card}>
              ...
              <div style={{background:'#0f172a', padding:'10px', borderRadius:'10px', border:'1px dotted #fbbf24'}}>
                <small>Send to: <b>{APP_CONFIG.ADMIN_WALLET}</b></small><br/>
                <small>MEMO (Required): <b style={{color:'#fbbf24'}}>{APP_CONFIG.MY_UID}</b></small>
              </div>
              <button style={{...styles.yellowBtn, marginTop:'10px'}} onClick={() => setShowAddTask(false)}>CONFIRM PAYMENT</button>
            </div>
          )}
