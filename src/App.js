...
function App() {
  ...
  // Updated: Trigger Adsterra on ANY click anywhere on the app
  useEffect(() => {
  ...
  // Process Reward with 7s timer check
  ...
  // Safe Navigate with 7s timer check
  ...
  // ADMIN: Function to force update withdrawal status to Success
