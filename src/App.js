...
function App() {
  ...
  const [dynamicCodes, setDynamicCodes] = useState([]); // Database က code များအတွက်
  ...
  const [adminNewPromoCode, setAdminNewPromoCode] = useState(''); // Admin အတွက်
  ...
  // Data ဖတ်တဲ့အခါ Promo Codes တွေကိုပါ ဖတ်အောင် ပြင်ထားပါတယ်
