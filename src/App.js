              ...
              <div>
                ...
                {searchedUser && (
                  <div style={{background: '#fffbeb', padding: '10px', borderRadius: '10px', border: '1px solid #f59e0b', fontSize: '12px'}}>
                    <p>Balance: {Number(searchedUser.balance).toFixed(5)}</p>
      ...
      {activeNav === 'withdraw' && (
        <>
          <div style={styles.card}>
            ...
            <p style={{fontSize: '12px'}}>Admin Wallet: <b>{APP_CONFIG.ADMIN_WALLET}</b></p>
            <button style={{...styles.btn, background: '#0ea5e9', padding: '8px', fontSize: '10px'}} onClick={() => { navigator.clipboard.writeText(APP_CONFIG.ADMIN_WALLET); alert("Copied!"); }}>COPY WALLET</button>
          </div>
          <div style={styles.card}>
            <h3>Withdraw TON</h3>
